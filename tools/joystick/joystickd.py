...
def joystickd_thread():
  ...
  while 1:
    ...
    CC.enabled = True  # Force enabled for joystick control
    CC.latActive = not sm['carState'].steerFaultTemporary and not sm['carState'].steerFaultPermanent  # Bypass engagement requirement
